...
public:
    ...
    // Called when GOWVR::initialize finishes in the first render frame
...
//    virtual void on_lua_state_destroyed(sol::state& lua) {};
    ...
    // Functionally equivalent, but on_frame will always get called, on_draw_ui can be disabled by GOWVR
